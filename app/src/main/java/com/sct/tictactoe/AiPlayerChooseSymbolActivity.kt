...
class AiPlayerChooseSymbolActivity : AppCompatActivity(), OnTouchListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_ai_player_choose_symbol)
...
//        MobileAds.setRequestConfiguration(configuration);
        ...
        CrossImg = findViewById<ImageView>(R.id.aiPickSideCrossImg)
        CircleImg = findViewById<ImageView>(R.id.aiPickSideCircleImg)
        CrossRadioImg = findViewById<ImageView>(R.id.aiPickSideCrossRadio)
        CircleRadioImg = findViewById<ImageView>(R.id.aiPickSideCircleRadio)

        ContinueBtn = findViewById<Button>(R.id.aiPickSideContinueBtn)
        ...
        ContinueBtn!!.setOnClickListener(View.OnClickListener { v: View? ->
            val intent = Intent(this@AiPlayerChooseSymbolActivity, AiGameBoardActivity::class.java)
