...
class AiGameBoardActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private val Boxes =
        arrayOf<ImageView?>(Box_1, Box_2, Box_3, Box_4, Box_5, Box_6, Box_7, Box_8, Box_9)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_ai_game_board)
...
//        MobileAds.setRequestConfiguration(configuration);
        ...
        settingsGifView = findViewById<GifImageView>(R.id.ai_game_seting_gifview)
        ...
        settingsGifView!!.setOnClickListener(View.OnClickListener { v: View? ->
            ...
            handler.postDelayed(Runnable {
                ...
                val intent = Intent(this@AiGameBoardActivity, SettingsActivity::class.java)
    ...
    private fun AI() {
        val board: Array<CharArray?>? = arrayOf<CharArray?>(
            charArrayOf(' ', ' ', ' '),
            charArrayOf(' ', ' ', ' '),
            charArrayOf(' ', ' ', ' ')
        )
        ...
        val bestMove = Minmax.findBestMove(board)
    ...
    private fun celebrateDialog(player_check: Int) {
        ...
        quitBtn.setOnClickListener(View.OnClickListener { v: View? ->
            dialog!!.dismiss()
            val intent = Intent(this@AiGameBoardActivity, ChooseGamePlayModeActivity::class.java)
            startActivity(intent)
        })
    ...
    private fun robotDialogFunction() {
        robotdialog!!.setContentView(R.layout.robot_win_dialog)
        robotdialog!!.getWindow()!!.setBackgroundDrawable(ColorDrawable(Color.TRANSPARENT))
        robotdialog!!.setCanceledOnTouchOutside(false)

        val quitBtn = robotdialog!!.findViewById<Button>(R.id.offline_game_draw_quit_btn)
        val continueBtn = robotdialog!!.findViewById<Button>(R.id.offline_game_draw_continue_btn)
    ...
    private fun quitDialogFunction() {
        ...
        quitdialog!!.getWindow()!!.setBackgroundDrawable(ColorDrawable(Color.TRANSPARENT))
